...
title = "【KO1KEYZ】YUKIコイノート写真の場所とカワウソの正体は？"
...
blocks.append(minibox('<p style="margin:0;"><strong>新しい家族の正体(推定):</strong>新江ノ島水族館のハズレなし「ぬいぐるみクジ」(1等〜3等など)の景品、コツメカワウソのぬいぐるみ「ハッピーマリン」</p>'))
blocks.append(p([
...
✔ <strong>話題の家族:</strong>新江ノ島水族館のハズレなし「ぬいぐるみクジ」(1等〜3等など)で当たるコツメカワウソのぬいぐるみ「ハッピーマリン」とみられる<br>
✔ <strong>過去の訪問歴:</strong>夜に撮影されたとみられる写真もあり、以前から江ノ島を訪れている可能性がある
</p>
<p style="margin:10px 0 0 0;">江ノ島水族館や神奈川県内で、ばったりYUKIに会えるのでは…?と少し期待してしまうくらい、江ノ島がお気に入りのようですね!<br>
公式サイトによると、このぬいぐるみクジは数に限りがあり、<strong><span class="swl-marker mark_yellow" style="font-size:1.15em;text-decoration:underline;">なくなり次第終了</span></strong>とのこと。<br>
YUKIと同じ「ハッピーマリン」を家族に迎えたいなら、早めに新江ノ島水族館へ足を運ぶしかなさそうです!筆者も今すぐ行きたくなってきました、気になった方はぜひ一緒に挑戦してみましょう!</p>
</div>
</div>'''))
