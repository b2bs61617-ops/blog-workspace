...
blocks.append(p([
    ...
    "新江ノ島水族館の公式TikTokアカウントによると、ぬいぐるみクジのラインナップはカワウソのほかアザラシ・シュモクザメなどもあり、<strong>1回1,000円、2階の「オッターショップ」</strong>で実施されているとのことです。",
    "等級によってぬいぐるみのサイズが異なるようですが、YUKIが実際に何等を引いたのか、どのサイズを手に入れたのかまでは分かっていません。",
