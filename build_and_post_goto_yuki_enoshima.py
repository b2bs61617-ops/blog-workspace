...
blocks.append(minibox('<p style="margin:0;"><strong>新しい家族の正体(推定):</strong>ぬいぐるみ「ハッピーマリン-カワウソ」、新江ノ島水族館など水族館・動物園のくじや売店で入手できるアイテム</p>'))
blocks.append(p([
    ...
    "SNS上では、このカワウソのぬいぐるみが<strong>「ハッピーマリン-カワウソ」</strong>という商品ではないかという指摘があり、<strong><span class=\"swl-marker mark_yellow\">新江ノ島水族館をはじめとした水族館・動物園のくじ、もしくは売店で販売されている</span></strong>アイテムだと紹介されていました。",
    "水族館を訪れた流れとあわせて考えると、コイノートの写真に写っていた場所が新江ノ島水族館だとみられることとも整合しており、館内のくじや売店でこのぬいぐるみを手に入れた可能性が高そうです。",
    "ただし、YUKI本人からの詳しい説明はまだなく、あくまで写真・コメント・SNSでの指摘から推測できる範囲にとどまる点には留意が必要です。",
]))
...
✔ <strong>話題の家族:</strong>ぬいぐるみ「ハッピーマリン-カワウソ」とみられ、新江ノ島水族館など水族館・動物園のくじ・売店で入手できるアイテム<br>
