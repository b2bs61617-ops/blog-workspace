...
eyecatch_media = upload_media(
    ROOT / "images" / "miyachika_kaito_carhartt_shirt_eyecatch_chomoand4.png",
...
# ---------- content builders (same content as chomoand-0.com post) ----------
...
blocks.append(linkbox("あわせて読みたい", [
    '<a href="https://chomoand-4.blog/?p=207" target="_blank" rel="noopener">コストコで着てたTシャツはCarhartt WIPと判明！</a>',
    '<a href="https://chomoand-4.blog/?p=202" target="_blank" rel="noopener">コストコでかぶっていたキャップは6CRAYONと判明！</a>',
    '<a href="https://chomoand-4.blog/?p=189" target="_blank" rel="noopener">トラジャがコストコで発見したものは？店はどこ？</a>',
]))
