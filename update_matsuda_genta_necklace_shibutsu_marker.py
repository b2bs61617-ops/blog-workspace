...
if __name__ == "__main__":
    ...
    old = "ただし、写真が投稿されたのは仕事のオフショットではなく、家族とディズニーで過ごした時間を振り返る本人の公式Instagram投稿であることを踏まえると、<strong>私物である可能性が高い</strong>と考えられます。"
    new = 'ただし、写真が投稿されたのは仕事のオフショットではなく、家族とディズニーで過ごした時間を振り返る本人の公式Instagram投稿であることを踏まえると、<strong><span class="swl-marker mark_blue" style="font-size:1.15em;">私物である可能性が高い</span></strong>と考えられます。'

    assert old in content, "target sentence not found"
