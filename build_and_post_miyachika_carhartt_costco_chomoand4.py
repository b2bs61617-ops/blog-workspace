...
# ---------- content builders (same content as chomoand-0.com post 1072) ----------
...
blocks.append(linkbox("あわせて読みたい", [
    ...
    '<a href="https://chomoand-4.blog/?p=198" target="_blank" rel="noopener">松倉海斗がコストコで着ていたTシャツはMM6と判明！</a>',
    '<a href="https://chomoand-4.blog/?p=202" target="_blank" rel="noopener">松田元太がコストコでかぶっていた帽子は6CRAYONと判明！</a>',
]))
