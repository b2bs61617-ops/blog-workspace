...
| YouTubeタレント監視(`tools/youtube-talent-monitor/`) | chomoand-0向け。旧ジャニーズ所属・出身タレントの公式YouTube新着を**RSS(APIキー不要)**でチェックし文字起こし付きでLINE通知(2026-07-29〜、検知・通知までのフェーズ1)。監視対象は`channels.json`、詳細は[docs/tools.md](docs/tools.md) |
