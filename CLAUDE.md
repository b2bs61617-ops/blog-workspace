...
| KO1KEYZ YouTube監視(`tools/koikeyz-youtube-monitor/`) | chomoand-1向け。上記YouTubeタレント監視と同じ仕組みをKO1KEYZ公式+PRODUCE 101 JAPAN公式の2チャンネルに適用(2026-07-30〜、タスクスケジューラで毎日23:10実行)。メンバー個人チャンネルはデビュー前(2026-10-07デビュー予定)のため未対応。詳細は[docs/tools.md](docs/tools.md) |
