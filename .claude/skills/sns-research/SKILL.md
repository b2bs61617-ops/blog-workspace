...
**コメント欄にもヒントがあることが多い(2026-07-24・トモキ明言)**: 本人の投稿本文・画像だけでなく、X/Instagramのコメント欄(友人・ファンとのやりとり)に地名・学校名・家族関係などのヒントが書き込まれていることが多い。Xiyで収集する際は投稿本文と画像だけで満足せず、目立つ投稿のコメント欄も確認する。恋リア出演者の調査(今日好き以外の番組で新シーズンの出演者が発表された場合も含む)では特に徹底すること。
