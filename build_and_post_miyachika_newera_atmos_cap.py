...
# ---------- content builders ----------
title = "宮近海斗の帽子はNEW ERA×atmos?25周年モデルと判明!"
...
blocks.append(p([
    "Travis Japanの宮近海斗が、Kis-My-Ft2の千賀健永と一緒に写った1枚が2026年8月19日にXで話題になりました。",
    "写真の中で宮近海斗がかぶっていた帽子は、<strong>NEW ERA×atmosのコラボ9FIFTYスナップバック(参考価格¥7,150)</strong>で、atmosの創業25周年を記念したモデルと特定されています。",
    "この記事では帽子のブランド・デザインの特徴に加え、2人が一緒に写っていた経緯についても詳しく紹介します。",
]))
...
blocks.append(p([
    ...
    "冒頭で紹介した2ショットは、この夏休みの集まりの中で撮られた1枚だったというわけです。",
]))
