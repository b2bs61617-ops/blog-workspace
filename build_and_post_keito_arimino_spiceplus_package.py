...
<p>KO1KEYZ의 KEITO(오노 케이토)를 두고, 「드러그스토어에서 파는 헤어 왁스 패키지에 찍혀 있는 사람이 KEITO 아니야?」라는 목소리가 X에서 퍼졌습니다.<br>
...
<p>Fans have been passing around the idea that KEITO (Keito Ono) of KO1KEYZ is the person pictured on the package of a hair wax sold in Japanese drugstores.<br>
