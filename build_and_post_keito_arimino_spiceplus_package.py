...
다만 <strong>아리미노와 KEITO 측 어느 쪽에서도 공식 발표는 없으며, 패키지 모델이 KEITO 본인인지 여부는 현재 확인되지 않았습니다</strong>. 이 기사에서는 무엇이 화제가 되고 있는지, 문제의 왁스가 어떤 상품인지, 그리고 KEITO의 「일반인 시절」 활동을 근거로 「있을 법한 이야기인지」를 정리합니다.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">문제의 왁스 「아리미노 스파이스 플러스 웨트 왁스」란?</h2>
<!-- /wp:heading -->
