...
blocks.append(minibox('<p style="margin:0;"><strong>화제 포인트:</strong>댓글창에 "새 가족 맞이한 거 잘됐다", "새 가족 귀엽다" 같은 반응이 이어지고 있음</p>'))
blocks.append(p([
    ...
    "수족관을 방문한 흐름과 함께 생각해보면, 관내 매장에서 수달을 모티브로 한 인형이나 굿즈를 구입했을 가능성이 있어 보이지만, 이 부분에 대해 YUKI 본인의 자세한 설명은 아직 없어 어디까지나 사진과 댓글로 추측할 수 있는 범위에 머무릅니다.",
]))
