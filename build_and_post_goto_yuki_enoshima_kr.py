...
blocks.append(p([
    ...
    "신에노시마 수족관 공식 틱톡 계정에 따르면, 인형 뽑기 라인업은 수달 외에도 물범·귀상어 등이 있으며, <strong>1회 1,000엔, 2층 \"오터숍\"</strong>에서 진행된다고 합니다.",
    "등급에 따라 인형의 크기가 다른 것으로 보이지만, YUKI가 실제로 몇 등을 뽑았는지, 어떤 사이즈를 손에 넣었는지까지는 알려져 있지 않습니다.",
    "수족관을 방문한 흐름과 함께 생각해보면, 코이노트 사진 속 장소가 신에노시마 수족관으로 보인다는 점과도 맞아떨어져, 관내 인형 뽑기에서 이 \"해피 마린\"을 손에 넣었을 가능성이 높아 보입니다.",
    "다만 YUKI 본인의 자세한 설명은 아직 없어, 어디까지나 사진·댓글·상품 정보로 추측할 수 있는 범위에 머무른다는 점은 유의할 필요가 있습니다.",
]))
