...
blocks.append(minibox('<p style="margin:0;"><strong>새 가족의 정체(추정):</strong>인형 "해피 마린-수달", 신에노시마 수족관 등 수족관·동물원의 뽑기나 매점에서 구할 수 있는 아이템</p>'))
blocks.append(p([
    "이번 코이노트 업데이트를 둘러싸고, YUKI가 새로 맞이했다는 '가족'도 화제가 되고 있습니다.",
    "댓글창에는 '귀여운 가족 맞이해서 다행이야 유이 덕분에 오늘도 행복해', '새 가족 귀여워' 같은 반응이 이어지고 있어, YUKI가 어떤 인형이나 굿즈를 새로 맞이한 것으로 보입니다.",
    "SNS에서는 이 수달 인형이 <strong>\"해피 마린-수달\"</strong>이라는 상품이 아니냐는 지적이 있었고, <strong>신에노시마 수족관을 비롯한 수족관·동물원의 뽑기나 매점에서 판매되는</strong> 아이템으로 소개되고 있었습니다.",
    "수족관을 방문한 흐름과 함께 생각해보면, 코이노트 사진 속 장소가 신에노시마 수족관으로 보인다는 점과도 맞아떨어져, 관내 뽑기나 매점에서 이 인형을 손에 넣었을 가능성이 높아 보입니다.",
    "다만 YUKI 본인의 자세한 설명은 아직 없어, 어디까지나 사진·댓글·SNS상의 지적으로 추측할 수 있는 범위에 머무른다는 점은 유의할 필요가 있습니다.",
]))
...
✔ <strong>화제의 가족:</strong>인형 "해피 마린-수달"로 보이며, 신에노시마 수족관 등 수족관·동물원 뽑기·매점에서 구할 수 있는 아이템<br>
