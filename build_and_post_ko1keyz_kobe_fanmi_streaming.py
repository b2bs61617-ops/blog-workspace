...
title = "KO1KEYZ神戸ファンミが生配信決定！視聴方法やチケットは？"
...
blocks.append(p([
    "ただ、配信開始が平日の18:30というのは、夕食や家事とちょうど重なりやすい時間帯です。とくに小さな子どもがいる家庭だと、落ち着いて画面の前に座るのが難しいという人も多そうです。",
    "生配信のみで巻き戻しやアーカイブがないのも、リアルタイムで張り付けない人にとっては正直なところ少しつらい仕様です。開始時刻に間に合わせられるよう、当日の予定を早めに調整しておけると安心です。",
    "この記事は、配信サービスの追加や視聴方法の変更など、続報が入り次第そのつど更新していきます。",
]))
